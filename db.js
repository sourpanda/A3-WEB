...
module.exports.initialize = function(){
    return new Promise((resolve, reject)=>{
        let monDB = mongoose.createConnection(`mongodb+srv://clint:${mongPW}@clintcluster.7ta6u.mongodb.net/users?retryWrites=true&w=majority`, {useNewUrlParser: true, useUnifiedTopology: true});
        monDB.on('error', (err) =>{
            reject(err);
        });
        monDB.once('open', ()=>{
